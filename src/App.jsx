...
function App() {
  ...
  // Security Fix: Rely strictly on database profile.role (protected by RLS) to prevent auth bypass.
  // Do not fall back to user.user_metadata.role which is client-modifiable.
