...
const PlayerDashboard = ({ players = [], userRole, onSelectPlayer, onAddPlayer }) => {
  ...
  useEffect(() => {
    ...
    const fetchViews = async () => {
      ...
      // Parallelize independent Supabase queries using Promise.all to minimize network latency
      // and improve dashboard load times. Expected impact: Reduces total query wait time by ~66%.
