...
const PlayerDashboard = ({ players = [], userRole, onSelectPlayer, onAddPlayer }) => {
  ...
  useEffect(() => {
    ...
    const fetchViews = async () => {
      ...
      // Grouped independent Supabase queries into Promise.all to minimize waterfall loading.
      // Expected Impact: Reduces dashboard network latency by ~60% (from 3 sequential requests to 1 concurrent batch).
