...
const PlayerDashboard = ({ players = [], userRole, onSelectPlayer, onAddPlayer }) => {
  ...
  useEffect(() => {
    ...
    const fetchViews = async () => {
      // ⚡ Bolt: Parallelize independent view count queries using Promise.all to reduce total network latency.
      // Since supabase client resolves all responses as {data, error, count}, this won't short-circuit if one fails.
      const [
        { count, error },
