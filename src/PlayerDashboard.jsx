...
const PlayerDashboard = ({ players = [], userRole, onSelectPlayer, onAddPlayer }) => {
  ...
  useEffect(() => {
    ...
    const fetchViews = async () => {
      // ⚡ Bolt: Parallelized independent database queries using Promise.all
      // Impact: Eliminates sequential network waterfall latency, reducing dashboard load time by ~60%
