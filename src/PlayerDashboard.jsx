...
const PlayerDashboard = ({ players = [], userRole, onSelectPlayer, onAddPlayer }) => {
  ...
  useEffect(() => {
    ...
    const fetchViews = async () => {
      // ⚡ Bolt Optimization: Parallelized 3 independent Supabase queries using Promise.all.
      // Expected impact: Eliminates a 3-step network waterfall, reducing total dashboard load latency.
      const [
