  ...
  return (
    <div className="container animate-up">
      ...
      {userRole === 'player' && players.length > 0 ? (
        <div className="hero-block" style={{ padding: '4rem 2rem', textAlign: 'center' }}>
        ...
        <>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '2rem', marginBottom: '4rem' }}>
            <div className="sport-card" style={{ textAlign: 'center', padding: '3rem 2rem' }}>
              ...
              <p className="text-muted" style={{ margin: 0, fontSize: '1.05rem' }}>Register your details, position, and performance attributes.</p>
            </div>
            <div className="sport-card" style={{ textAlign: 'center', padding: '3rem 2rem' }}>
              ...
              <p className="text-muted" style={{ margin: 0, fontSize: '1.05rem' }}>Add match footage and video clips showing your best moments.</p>
            </div>
            <div className="sport-card" style={{ textAlign: 'center', padding: '3rem 2rem' }}>
              ...
              <p className="text-muted" style={{ margin: 0, fontSize: '1.05rem' }}>Stand out to scouts with AI-driven performance reports.</p>
            </div>
          </div>
        </>
      ) : (
