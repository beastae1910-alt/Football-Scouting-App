...
const RoleSelection = ({ user, onRoleSelected }) => {
  ...
  const handleSelectRole = async (role) => {
    ...
    try {
      ...
      // SECURITY: Removed vulnerable updateUser call that allowed arbitrary role injection
      // Trust the server-side profiles table instead of client-side user_metadata
      onRoleSelected(role);
    } catch (err) {
