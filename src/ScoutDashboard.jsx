...
const ScoutDashboard = ({ players = [], onSelectPlayer }) => {
  ...
  useEffect(() => {
    ...
    const fetchScoutData = async () => {
      ...
      // ⚡ Bolt Optimization: Parallelized independent view queries using Promise.all.
      // Expected impact: Speeds up scout dashboard data hydration by resolving queries concurrently.
      const [
