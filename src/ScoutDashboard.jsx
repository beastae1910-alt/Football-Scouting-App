...
const ScoutDashboard = ({ players = [], onSelectPlayer }) => {
  ...
  // ⚡ Bolt: Memoize filtered list to prevent expensive re-evaluations during unrelated renders (e.g. tracking searches or setting top players).
  // Expected impact: Reduced render time proportional to player count.
