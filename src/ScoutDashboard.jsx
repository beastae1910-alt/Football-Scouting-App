...
const ScoutDashboard = ({ players = [], onSelectPlayer }) => {
  ...
  // ⚡ Bolt: Memoize filtered array based on search and filter criteria to
  // prevent O(N) recalcs on other state updates.
  ...
  }, [safePlayers, searchQuery, filterPosition, filterAge]);
